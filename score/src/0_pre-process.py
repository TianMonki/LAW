...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained("llm/Llama-2-7b-hf")
    ...
    parser.add_argument('--window_size', type=int, default=8192, help='Window size for sliding window sampling.')
